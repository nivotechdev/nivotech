    ...
    >
      <motion.div
        ...
        className={cn(
          ...
          "border border-primary/20 bg-card/60 backdrop-blur-xl",
          "transition-all duration-500 ease-out",
          "group-hover:border-primary/60 group-hover:scale-105 group-hover:bg-primary/5 shadow-2xl shadow-primary/5"
        )}
      >
